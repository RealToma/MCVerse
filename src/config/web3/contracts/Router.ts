...
export const routerContract: IContractInfo = {
  addressMap: {
    [SupportedChainId.AVALANCHE]: isProd ? '0x60aE616a2155Ee3d9A68541Ba4544862310933d4' : '0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901',
  },
  abi: [
    {
      inputs: [],
